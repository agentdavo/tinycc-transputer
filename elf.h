...
#define R_TRANSPUTER_TLS_GOTIE	27	/* GOT offset for static TLS block offset.  */
#define R_TRANSPUTER_TLS_IE	    28	/* GOT address for static TLS block offset.  */
#define R_TRANSPUTER_TLS_LE	    29	/* Offset relative to static TLS block.  */
#define R_TRANSPUTER_TLS_DTPOFF	31	/* Offset in module TLS block.  */
#define R_TRANSPUTER_TLS_TPOFF	32	/* Offset in static TLS block.  */
#define R_TRANSPUTER_SYM_DIFF	33	/* Adjustment for next reloc as needed by linker relaxation.  */
#define R_TRANSPUTER_ALIGN	    34	/* Alignment requirement for linker relaxation.  */
